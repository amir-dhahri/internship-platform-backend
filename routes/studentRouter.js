...
//Delete Task 
studentRouter.delete("/tasks/delete/:id", isLogin, isStudent, deleteTask)
...
studentRouter.get("/training-applications", isLogin, isStudent, getTrainingApplications);
